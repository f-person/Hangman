...
##            return False
##        if len(secret_word)==len(letters_guessed): #i==secret_word[-1] and i in secret_word and :
##            return True
####    for i in secret_word:
####        if i not in letters_guessed:
####            return False
####        if i==secret_word[-1] and i in secret_word:
####            return True
#print(is_word_guessed("hello",['l','o','h','e','s']))
...
def get_guessed_word(secret_word, letters_guessed):
    ...
    for i in secret_word:
        if i in letters_guessed:
            ...
            word+="_ "
    return word
#print(get_guessed_word("hello",['l','o','c','f']))
...
def get_available_letters(letters_guessed):
    ...
    d=''.join(d)
    return d
##print(get_available_letters(['d','a']))
...
##            break
##        elif is_word_guessed(word, letters):
##            print("Congratulations, you won!")
##            total_score=guess*len(unique)
##            print("Your total score for this game is: ",total_score)
            #cc+=1
    if is_word_guessed(word, letters) == True:
        print("Congratulations, you won!")
        total_score=guess*len(unique)
        print("Your total score for this game is: ",total_score)
